 ...
 * 
 */
public class MQHelloWorldAPIFlowFailureTest extends FlowTest {
	...
	private static final String TEST_FILE_001 = "MQHelloWorldAPI.FailTest001.xml";
	private static final String applicationName = "MQHelloWorldAPI-app";
	...
	public void injectData() throws IOException, ConfigManagerProxyPropertyNotInitializedException, ConfigManagerProxyLoggedException {
		...
		String message = IOUtils.toString(MQHelloWorldAPIFlowTest.class.getResourceAsStream(TEST_FILE_001));
		//String jsonBlob = TransformUtils.getBlob(message);
		//String messageFormat = IOUtils.toString(MQHelloWorldAPIFlowTest.class.getResourceAsStream(MESSAGE_FORMAT));
